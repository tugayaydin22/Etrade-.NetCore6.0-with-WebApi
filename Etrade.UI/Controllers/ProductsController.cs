...
namespace Etrade.UI.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,CategoryId,Image,Stock,Price,IsHome,IsApproved")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,CategoryId,Image,Stock,Price,IsHome,IsApproved")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
